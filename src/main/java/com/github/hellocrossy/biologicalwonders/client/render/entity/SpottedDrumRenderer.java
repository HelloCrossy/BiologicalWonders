...
public class SpottedDrumRenderer extends ZawaMobRenderer<SpottedDrumEntity, SpottedDrumModel> {
    public SpottedDrumRenderer(EntityRendererProvider.Context context) {
        super(context, new SpottedDrumModel(context.bakeLayer(BioModelLayers.SPOTTED_DRUM)), 0.2F);
    }
