...
public abstract class NapoleonWrasseModel extends ZawaBaseModel<NapoleonWrasseEntity> {
    ...
    public static class Adult extends NapoleonWrasseModel {
        ...
        public void playIdleAnimation(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
            ...
            this.Body.yRot = Mth.cos(1.0F + (limbSwing * speed * 0.2F)) * (degree * -0.4F) * limbSwingAmount;
        ...
        public void playMovementAnimation(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
            ...
            if (entity.isInWater()) {
                ...
                this.Body.yRot = Mth.cos(1.0F + (limbSwing * speed * 1F)) * (degree * -0.9F) * limbSwingAmount;
