...
public class BlacktipReefSharkRenderer extends ZawaMobRenderer<BlacktipReefSharkEntity, BlacktipReefSharkModel> {
    public BlacktipReefSharkRenderer(EntityRendererProvider.Context context) {
        super(context, new BlacktipReefSharkModel.Adult(context.bakeLayer(BioModelLayers.BLACKTIP_REEF_SHARK_ADULT)), new BlacktipReefSharkModel.Child(context.bakeLayer(BioModelLayers.BLACKTIP_REEF_SHARK_CHILD)), 0.6F);
    }

    protected void setupRotations(BlacktipReefSharkEntity entity, PoseStack stack, float p_225621_3_, float p_225621_4_, float p_225621_5_) {
    ...
    @Override
    protected void scale(BlacktipReefSharkEntity entity, PoseStack PoseStack, float partialTickTime) {
