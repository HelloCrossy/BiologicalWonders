...
public class CowfishModel extends SegmentedModel<CowfishEntity> {
    ...
    public CowfishModel() {
        ...
        this.TailFinTop = new ModelRenderer(this, 0, 10);
        ...
        this.PectoralFinRight = new ModelRenderer(this, 35, 16);
        ...
        this.UnderFinLeft = new ModelRenderer(this, 16, 18);
        ...
        this.HornLeft = new ModelRenderer(this, 0, 25);
        ...
        this.Thorn1 = new ModelRenderer(this, 0, 0);
        ...
        this.PectoralFinLeft = new ModelRenderer(this, 25, 16);
        ...
        this.UnderFinRight = new ModelRenderer(this, 20, 23);
        ...
        this.HornRight = new ModelRenderer(this, 11, 25);
        ...
        this.Thorn2 = new ModelRenderer(this, 0, 0);
