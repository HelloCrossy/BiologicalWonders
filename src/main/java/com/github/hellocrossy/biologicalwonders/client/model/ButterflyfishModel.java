...
public class ButterflyfishModel extends SegmentedModel<ButterflyfishEntity> {
    ...
    public ButterflyfishModel() {
        this.texWidth = 32;
        this.texHeight = 32;
        this.PectoralFinLeft = new ModelRenderer(this, 0, 17);
        ...
        this.TailFinTop = new ModelRenderer(this, 15, 17);
        ...
        this.PelvicFinRight = new ModelRenderer(this, 0, 20);
        ...
        this.TailFinBottom = new ModelRenderer(this, 15, 17);
        ...
        this.PelvicFinLeft = new ModelRenderer(this, 19, 8);
        ...
        this.DorsalFin = new ModelRenderer(this, 0, 6);
