...
public abstract class GreySealModel extends ZawaBaseModel<GreySealEntity> {
    ...
    public static class Adult extends GreySealModel {
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            PartDefinition Chest = partDefinition.addOrReplaceChild("Chest", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F), PartPose.offsetAndRotation(0.0F, 20.0F, -2.0F, 0.0781907508222411F, 1.7453292129831807E-4F, 0.0F));
            ...
            PartDefinition Snout = Head.addOrReplaceChild("Snout", CubeListBuilder.create().texOffs(31, 28).addBox(-1.5F, 0.0F, -2.5F, 3.0F, 3.0F, 4.0F), PartPose.offsetAndRotation(0.0F, -1.7F, -3.1F, 0.36477380700891215F, 0.0F, 0.0F));
            PartDefinition Mouth = Snout.addOrReplaceChild("Mouth", CubeListBuilder.create().texOffs(32, 36).addBox(-1.5F, -0.5F, -1.7F, 3.0F, 1.0F, 3.0F, new CubeDeformation(-0.1F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 3.2F, -0.6F, -0.34487706418882114F, 0.0F, 0.0F));
    ...
    public static class Child extends GreySealModel {
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            PartDefinition Snout = Head.addOrReplaceChild("Snout", CubeListBuilder.create().texOffs(31, 8).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 2.0F, 3.0F), PartPose.offsetAndRotation(0.0F, -1.2F, -2.5F, 0.4820599540482198F, 0.0F, 0.0F));
