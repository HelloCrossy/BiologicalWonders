...
public class MoorishIdolModel extends SegmentedModel<MoorishIdolEntity> {
    ...
    public MoorishIdolModel() {
        ...
        this.TailFinBottom.setPos(0.01F, 0.2F, 0.3F);
        ...
        this.UpperMouth.setPos(0.01F, 1.2F, -0.3F);
        ...
        this.DorsalFin4_1 = new ModelRenderer(this, 14, 13);
        ...
        this.LeftPelvicFin = new ModelRenderer(this, 12, 27);
        ...
        this.AnalFin.setPos(0.0F, 3.5F, 2.8F);
        ...
        this.LowerMouth.addBox(-0.5F, -0.5F, -3.0F, 1.0F, 1.0F, 3.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.RightPelvicFin = new ModelRenderer(this, 12, 27);
