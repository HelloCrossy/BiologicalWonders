...
public class MoorishIdolModel extends SegmentedModel<MoorishIdolEntity> {
    ...
    public MoorishIdolModel() {
        ...
        this.Tail2 = new ModelRenderer(this, 13, 0);
        ...
        this.DorsalFin1 = new ModelRenderer(this, 12, 12);
        ...
        this.DorsalFin2 = new ModelRenderer(this, 12, 12);
        ...
        this.LowerMouth = new ModelRenderer(this, 5, 21);
        ...
        this.RightPelvicFin = new ModelRenderer(this, 0, 20);
        ...
        this.LeftPelvicFin = new ModelRenderer(this, 19, 8);
        ...
        this.DorsalFin3 = new ModelRenderer(this, 12, 12);
        ...
        this.TailFinTop = new ModelRenderer(this, 14, 18);
        ...
        this.DorsalFin4_1 = new ModelRenderer(this, 12, 12);
        ...
        this.Head_1 = new ModelRenderer(this, 12, 12);
        ...
        this.DorsalFin4 = new ModelRenderer(this, 0, 6);
        ...
        this.TailFinBottom = new ModelRenderer(this, 13, 0);
        ...
        this.LeftPectoralFin = new ModelRenderer(this, 0, 17);
        ...
        this.UpperMouth = new ModelRenderer(this, 16, 20);
