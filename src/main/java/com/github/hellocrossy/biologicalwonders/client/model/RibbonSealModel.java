...
public abstract class RibbonSealModel extends ZawaBaseModel<RibbonSealEntity> {
    ...
    public static class Adult extends RibbonSealModel {
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            PartDefinition Snout = Head.addOrReplaceChild("Snout", CubeListBuilder.create().texOffs(32, 29).addBox(-1.5F, 0.0F, -2.5F, 3.0F, 3.0F, 3.0F), PartPose.offsetAndRotation(0.0F, -1.55F, -1.0F, -0.10437068960215605F, 0.0F, 0.0F));
            ...
            PartDefinition TopSnout = Snout.addOrReplaceChild("TopSnout", CubeListBuilder.create().texOffs(45, 28).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 0.0F, -1.7F, 0.35779249665883756F, 0.0F, 0.0F));
    ...
    public static class Child extends RibbonSealModel {
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            PartDefinition Hips = Body.addOrReplaceChild("Hips", CubeListBuilder.create().texOffs(0, 23).addBox(-2.0F, 0.0F, -0.5F, 4.0F, 4.0F, 4.0F), PartPose.offsetAndRotation(0.0F, 0.5F, 5.0F, -0.1563815016444822F, 0.0F, 0.0F));
            ...
            PartDefinition Tail = Hips.addOrReplaceChild("Tail", CubeListBuilder.create().texOffs(31, 23).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 3.5F, -0.8991936386169619F, 0.0F, 0.0F));
            ...
            PartDefinition Neck = Chest.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(24, 0).addBox(-1.5F, -0.5F, -1.4F, 3.0F, 4.0F, 4.0F), PartPose.offsetAndRotation(0.0F, -2.3F, -3.0F, -0.19547687289441354F, 0.0F, 0.0F));
            PartDefinition Head = Neck.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(40, 0).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 1.4F, -1.0F, 0.19547687289441354F, 0.0F, 0.0F));
            PartDefinition Snout = Head.addOrReplaceChild("Snout", CubeListBuilder.create().texOffs(32, 9).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 2.0F, 2.0F), PartPose.offsetAndRotation(0.0F, -1.0F, -1.1F, 0.28658306450904947F, 0.0F, 0.0F));
