...
public abstract class LionfishModel extends ZawaBaseModel<LionfishEntity> {
    ...
    public static class Adult extends LionfishModel {
        ...
        public Adult() {
            ...
            this.setRotateAngle(PectoralFinLeft, -0.23457224414434488F, -0.49096110393861886F, 0.0F);
            ...
            this.setRotateAngle(PectoralFinRight, -0.23457224414434488F, 0.4910000193800477F, 0.0F);
            ...
            this.setRotateAngle(EyelashRight, -0.27314400463445304F, 0.0F, 0.0F);
            ...
            this.setRotateAngle(EyelashLeft, -0.27314400463445304F, 0.0F, 0.0F);
