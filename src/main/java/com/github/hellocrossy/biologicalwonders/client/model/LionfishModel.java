...
public abstract class LionfishModel extends ZawaBaseModel<LionfishEntity> {
    ...
    public static class Adult extends LionfishModel {
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            PartDefinition Body = partDefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -2.5F, -3.0F, 4.0F, 5.0F, 5.0F), PartPose.offset(0.0F, 20.0F, 0.0F));
            ...
            PartDefinition EyelashRight = RightEye.addOrReplaceChild("EyelashRight", CubeListBuilder.create().texOffs(0, 17).addBox(0.0F, -2.0F, -0.5F, 0.0F, 2.0F, 1.0F), PartPose.offsetAndRotation(-0.1F, 0.0F, 0.0F, -0.27314400463445304F, 0.0F, 0.0F));
            ...
            PartDefinition EyelashLeft = LeftEye.addOrReplaceChild("EyelashLeft", CubeListBuilder.create().texOffs(0, 17).mirror(true).addBox(0.0F, -2.0F, -0.5F, 0.0F, 2.0F, 1.0F), PartPose.offsetAndRotation(0.1F, 0.0F, 0.0F, -0.27314400463445304F, 0.0F, 0.0F));

            PartDefinition PectoralFinLeft = Body.addOrReplaceChild("PectoralFinLeft", CubeListBuilder.create().texOffs(-1, 13).addBox(0.0F, -4.5F, 0.0F, 0.0F, 9.0F, 8.0F), PartPose.offsetAndRotation(-1.9F, 0.5F, -2.5F, -0.23457224414434488F, -0.49096110393861886F, 0.0F));

            PartDefinition PectoralFinRight = Body.addOrReplaceChild("PectoralFinRight", CubeListBuilder.create().texOffs(-1, 13).mirror(true).addBox(0.0F, -4.5F, 0.0F, 0.0F, 9.0F, 8.0F), PartPose.offsetAndRotation(1.9F, 0.5F, -2.5F, -0.23457224414434488F, 0.4910000193800477F, 0.0F));
