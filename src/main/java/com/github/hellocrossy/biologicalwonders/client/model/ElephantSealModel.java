...
public abstract class ElephantSealModel extends ZawaBaseModel<ElephantSealEntity> {
    ...
    public void prepareMobModel(ElephantSealEntity entity, float speed, float walkSpeed, float partialTick) {
        ...
        this.isSwimming = entity.isUnderWater() || (entity.isInWater() && entity.level().getBlockState(entity.blockPosition().below()).liquid());
    }
    ...
    public static class AdultMale extends ElephantSealModel {
        ...
        public AdultMale(ModelPart root) {
            ...
            this.Forehead = this.SnoutTop.getChild("Forehead");
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            PartDefinition Chest = partDefinition.addOrReplaceChild("Chest", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, -6.5F, -6.0F, 12.0F, 13.0F, 12.0F), PartPose.offsetAndRotation(0.0F, 17.0F, -5.0F, -0.3134611176792151F, 1.7453292129831807E-4F, 0.0F));
            PartDefinition UpperArmLeft = Chest.addOrReplaceChild("UpperArmLeft", CubeListBuilder.create().texOffs(34, 56).addBox(-3.0F, -1.0F, -2.0F, 4.0F, 4.0F, 4.0F), PartPose.offsetAndRotation(5.5F, 2.0F, -3.0F, 0.4230678066886838F, -0.0911061832922575F, -0.6373942508178124F));
            ...
            PartDefinition ArmLeft = LowerArmLeft.addOrReplaceChild("ArmLeft", CubeListBuilder.create().texOffs(46, 49).addBox(-1.0F, -1.0F, -2.5F, 4.0F, 2.0F, 5.0F), PartPose.offsetAndRotation(0.0F, 2.7F, -0.3F, -0.0911061832922575F, -0.04555309164612875F, 0.4098033003787853F));
            PartDefinition HandLeft = ArmLeft.addOrReplaceChild("HandLeft", CubeListBuilder.create().texOffs(42, 40).addBox(0.0F, 0.0F, 0.0F, 6.0F, 1.0F, 5.0F), PartPose.offsetAndRotation(3.0F, -0.5F, -2.0F, 0.0F, -0.4098033003787853F, 0.0F));

            PartDefinition Body = Chest.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 25).addBox(-5.5F, 0.0F, -2.0F, 11.0F, 12.0F, 9.0F), PartPose.offsetAndRotation(0.0F, -6.0F, 5.5F, 0.23457224414434488F, 0.0F, 0.0F));
            PartDefinition Body2 = Body.addOrReplaceChild("Body2", CubeListBuilder.create().texOffs(0, 46).addBox(-4.5F, 0.0F, 0.0F, 9.0F, 10.0F, 6.0F), PartPose.offsetAndRotation(0.0F, 1.0F, 7.0F, -0.11728612207217244F, 0.0F, 0.0F));
            PartDefinition Hips = Body2.addOrReplaceChild("Hips", CubeListBuilder.create().texOffs(0, 62).addBox(-3.5F, 0.0F, 0.0F, 7.0F, 9.0F, 4.0F), PartPose.offset(0.0F, 0.5F, 6.0F));
            ...
            PartDefinition LegLeft = Hips.addOrReplaceChild("LegLeft", CubeListBuilder.create().texOffs(22, 65).addBox(-2.0F, -0.5F, 0.0F, 2.0F, 3.0F, 3.0F), PartPose.offsetAndRotation(3.5F, 4.5F, 1.6F, 0.0781907508222411F, 0.3909537457888271F, 0.0F));
            PartDefinition FootLeft = LegLeft.addOrReplaceChild("FootLeft", CubeListBuilder.create().texOffs(31, 66).addBox(0.0F, -2.0F, 0.0F, 1.0F, 4.0F, 6.0F), PartPose.offsetAndRotation(-1.2F, 1.0F, 2.5F, 0.0F, -0.3909537457888271F, 0.0F));

            PartDefinition LegRight = Hips.addOrReplaceChild("LegRight", CubeListBuilder.create().texOffs(22, 65).mirror(true).addBox(0.0F, -0.5F, 0.0F, 2.0F, 3.0F, 3.0F), PartPose.offsetAndRotation(-3.5F, 4.5F, 1.6F, 0.0781907508222411F, -0.3909537457888271F, 0.0F));
            PartDefinition FootRight = LegRight.addOrReplaceChild("FootRight", CubeListBuilder.create().texOffs(31, 66).mirror(true).addBox(-0.5F, -2.0F, 0.0F, 1.0F, 4.0F, 6.0F), PartPose.offsetAndRotation(1.2F, 1.0F, 2.5F, 0.0F, 0.3909537457888271F, 0.0F));

            PartDefinition Neck1 = Chest.addOrReplaceChild("Neck1", CubeListBuilder.create().texOffs(0, 90).addBox(-4.5F, -5.5F, -3.0F, 9.0F, 11.0F, 6.0F), PartPose.offsetAndRotation(0.0F, 0.0F, -5.0F, -0.5012585491885465F, 0.0F, 0.0F));
            PartDefinition Neck2 = Neck1.addOrReplaceChild("Neck2", CubeListBuilder.create().texOffs(0, 107).addBox(-4.0F, -5.0F, -4.0F, 8.0F, 10.0F, 7.0F), PartPose.offsetAndRotation(0.0F, 0.0F, -3.5F, 0.20193458912942175F, 0.0F, 0.0F));
            PartDefinition Neck3 = Neck2.addOrReplaceChild("Neck3", CubeListBuilder.create().texOffs(30, 111).addBox(-3.5F, -4.6F, -2.5F, 7.0F, 9.0F, 4.0F), PartPose.offsetAndRotation(0.0F, 0.0F, -4.0F, 0.33841933130905616F, 0.0F, 0.0F));
            PartDefinition Head = Neck3.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(16, 77).addBox(-3.0F, -3.0F, -4.0F, 6.0F, 7.0F, 5.0F), PartPose.offsetAndRotation(0.0F, -1.0F, -2.0F, 0.46216317793861517F, 0.0F, 0.0F));
            PartDefinition Snout = Head.addOrReplaceChild("Snout", CubeListBuilder.create().texOffs(0, 78).addBox(-2.0F, 0.0F, -3.0F, 4.0F, 3.0F, 3.0F), PartPose.offsetAndRotation(0.0F, -0.2F, -4.0F, 0.0911061832922575F, 0.0F, 0.0F));
            PartDefinition Mouth = Snout.addOrReplaceChild("Mouth", CubeListBuilder.create().texOffs(0, 84).addBox(-1.5F, 0.0F, -2.5F, 3.0F, 1.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 3.0F, 0.0F, -0.2275909337942703F, 0.0F, 0.0F));

            PartDefinition SnoutTop = Snout.addOrReplaceChild("SnoutTop", CubeListBuilder.create().texOffs(46, 75).addBox(-1.5F, -2.0F, -4.5F, 3.0F, 4.0F, 5.0F), PartPose.offsetAndRotation(0.0F, -1.0F, 0.6F, 0.3904301683185175F, 0.0F, 0.0F));
            PartDefinition Forehead = SnoutTop.addOrReplaceChild("Forehead", CubeListBuilder.create().texOffs(12, 76).addBox(-1.0F, -2.3F, -1.5F, 2.0F, 2.0F, 2.0F), PartPose.offsetAndRotation(0.0F, -1.0F, -0.2F, 0.5077162820683115F, 0.0F, 0.0F));

            PartDefinition Nose = SnoutTop.addOrReplaceChild("Nose", CubeListBuilder.create().texOffs(49, 84).addBox(-1.0F, -2.5F, -3.0F, 2.0F, 3.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 0.4F, -3.0F, 0.6373942508178124F, 0.0F, 0.0F));

            PartDefinition UpperArmRight = Chest.addOrReplaceChild("UpperArmRight", CubeListBuilder.create().texOffs(34, 56).mirror(true).addBox(-1.0F, -1.0F, -2.0F, 4.0F, 4.0F, 4.0F), PartPose.offsetAndRotation(-5.5F, 2.0F, -3.0F, 0.4230678066886838F, 0.0911061832922575F, 0.6373942508178124F));
            ...
            PartDefinition ArmRight = LowerArmRight.addOrReplaceChild("ArmRight", CubeListBuilder.create().texOffs(46, 49).mirror(true).addBox(-3.0F, -1.0F, -2.5F, 4.0F, 2.0F, 5.0F), PartPose.offsetAndRotation(0.0F, 2.7F, -0.3F, -0.0911061832922575F, 0.04555309164612875F, -0.4098033003787853F));
            PartDefinition HandRight = ArmRight.addOrReplaceChild("HandRight", CubeListBuilder.create().texOffs(42, 40).mirror(true).addBox(-6.0F, 0.0F, 0.0F, 6.0F, 1.0F, 5.0F), PartPose.offsetAndRotation(-3.0F, -0.5F, -2.0F, 0.0F, 0.4098033003787853F, 0.0F));
        ...
        public void playMovementAnimation(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
            ...
            if (this.isSwimming) {
                ...
                this.Neck3.xRot = Mth.cos(-1F + (limbSwing * speed * 0.2F)) * (degree * -0.25F) * limbSwingAmount;
                ...
                this.LegRight.xRot = Mth.cos((limbSwing * speed * 0.2F)) * (degree * 0.25F) * limbSwingAmount;
                this.FootRight.yRot = Mth.cos((limbSwing * speed * 0.2F)) * (degree * 0.6F) * limbSwingAmount + 0.2F;
                this.LegLeft.xRot = Mth.cos((limbSwing * speed * 0.2F)) * (degree * 0.25F) * limbSwingAmount;
                this.FootLeft.yRot = Mth.cos((limbSwing * speed * 0.2F)) * (degree * 0.6F) * limbSwingAmount - 0.2F;

            } else if (entity.onGround()) {
                this.UpperArmRight.y = Mth.cos(4.0F + (limbSwing * speed * 0.2F)) * (degree * 2.0F) * limbSwingAmount + 2.0F;
                ...
                this.UpperArmLeft.y = Mth.cos(4.0F + (limbSwing * speed * 0.2F)) * (degree * 2.0F) * limbSwingAmount + 2.0F;
                ...
                this.Neck1.xRot = Mth.cos(-1.0F + (limbSwing * speed * 0.2F)) * (degree * 0.2F) * limbSwingAmount - 0.50F;
                this.Neck2.xRot = Mth.cos(1.0F + (limbSwing * speed * 0.2F)) * (degree * 0.2F) * limbSwingAmount + 0.20F;
                this.Neck3.xRot = Mth.cos(1.0F + (limbSwing * speed * 0.2F)) * (degree * 0.1F) * limbSwingAmount + 0.34F;
                this.Head.xRot = Mth.cos(2.0F + (limbSwing * speed * 0.2F)) * (degree * -0.4F) * limbSwingAmount + 0.46F;
                this.SnoutTop.xRot = Mth.cos(3.0F + (limbSwing * speed * 0.2F)) * (degree * -0.3F) * limbSwingAmount + 0.39F;
                this.Nose.xRot = Mth.cos(1.0F + (limbSwing * speed * 0.2F)) * (degree * 0.2F) * limbSwingAmount + 0.64F;

                this.Chest.y = Mth.cos((limbSwing * speed * 0.2F)) * (degree * 3F) * limbSwingAmount + 17.0F;
                this.Chest.xRot = Mth.cos(1.0F + (limbSwing * speed * 0.2F)) * (degree * 0.6F) * limbSwingAmount - 0.1F;
                this.Body.xRot = Mth.cos((limbSwing * speed * 0.2F)) * (degree * -0.5F) * limbSwingAmount;
                this.Body2.xRot = Mth.cos(1.0F + (limbSwing * speed * 0.2F)) * (degree * -0.3F) * limbSwingAmount - 0.1F;
                this.Hips.xRot = Mth.cos(1.5F + (limbSwing * speed * 0.2F)) * (degree * -0.3F) * limbSwingAmount - 0.2F;

                this.LegRight.xRot = Mth.cos(2.0F + (limbSwing * speed * 0.2F)) * (degree * -0.6F) * limbSwingAmount;
                this.FootRight.xRot = Mth.cos(2.0F + (limbSwing * speed * 0.2F)) * (degree * -1.0F) * limbSwingAmount + 0.2F;
                this.FootRight.yRot = 0.2F;
                this.LegLeft.xRot = Mth.cos(2.0F + (limbSwing * speed * 0.2F)) * (degree * -0.6F) * limbSwingAmount;
                this.FootLeft.xRot = Mth.cos(2.0F + (limbSwing * speed * 0.2F)) * (degree * -1.0F) * limbSwingAmount + 0.2F;
    ...
    public static class AdultFemale extends ElephantSealModel {
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            PartDefinition Snout = Head.addOrReplaceChild("Snout", CubeListBuilder.create().texOffs(32, 29).addBox(-1.5F, 0.0F, -2.5F, 3.0F, 3.0F, 3.0F), PartPose.offsetAndRotation(0.0F, -1.7F, -2.2F, 0.2474876932591181F, 0.0F, 0.0F));
            PartDefinition TopSnout = Snout.addOrReplaceChild("TopSnout", CubeListBuilder.create().texOffs(45, 28).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 0.0F, -1.5F, 0.35779249665883756F, 0.0F, 0.0F));
    ...
    public static class Child extends ElephantSealModel {
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            PartDefinition Snout = Head.addOrReplaceChild("Snout", CubeListBuilder.create().texOffs(31, 8).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 2.0F, 3.0F), PartPose.offsetAndRotation(0.0F, -1.2F, -2.1F, 0.4820599540482198F, 0.0F, 0.0F));
            ...
            PartDefinition Mouth = Snout.addOrReplaceChild("Mouth", CubeListBuilder.create().texOffs(32, 16).addBox(-1.0F, 0.0F, -0.8F, 2.0F, 1.0F, 2.0F, new CubeDeformation(-0.1F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 1.6F, -0.9F, -0.5012585491885465F, 0.0F, 0.0F));
