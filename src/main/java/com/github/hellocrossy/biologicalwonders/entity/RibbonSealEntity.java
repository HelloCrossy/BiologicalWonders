...
public class RibbonSealEntity extends ZawaSemiAquaticEntity {
    public RibbonSealEntity(EntityType<? extends ZawaSemiAquaticEntity> type, Level world) {
        super(type, world);
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel world, AgeableMob entity) {
        return BioEntities.RIBBON_SEAL.get().create(world);
    }
