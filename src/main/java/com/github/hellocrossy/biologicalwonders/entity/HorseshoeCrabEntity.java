...
public class HorseshoeCrabEntity extends ZawaAmbientFishEntity {
    public HorseshoeCrabEntity(EntityType<? extends ZawaAmbientFishEntity> type, World world) {
        super(type, world);
    }
    ...
    protected ItemStack getBucketItemStack() {
        return new ItemStack(BioItems.HORSESHOE_CRAB_BUCKET.get());
    }
