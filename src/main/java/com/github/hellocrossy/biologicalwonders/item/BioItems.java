...
//    });
    ...
    public static final RegistryObject<Item> BLACKTIP_SHARK_EGG = ITEMS_REGISTRAR.register("blacktip_shark_egg", () -> new ZawaEggItem(BioEntities.BLACKTIP_SHARK, new Item.Properties().stacksTo(16)));
